#!/bin/bash
# 062c: Curriculum + no-shape + adaptive gate (boundaries 0/200/500/1000 = 058 original)
...
export RUN_NAME=062c_curriculum_noshape_adaptive_0_300_700_1100_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r062c_${PORT_SEED}
...
export CURRICULUM_PHASES="0:0.0,300:0.3,700:0.7,1100:1.0"
...
LOG=docs/experiments/artifacts/slurm-logs/062c_train_$(date +%Y%m%d_%H%M%S).log
