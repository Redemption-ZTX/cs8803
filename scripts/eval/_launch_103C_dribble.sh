...
PORT_SEED=${PORT_SEED:-123}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))

export RUN_NAME=103C_dribble_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r103C_${PORT_SEED}
...
export SHAPING_EVENT_SHOT_REWARD=0.0          # NO shot reward — saves shooting for 081 NEAR-GOAL specialist
...
LOG=docs/experiments/artifacts/slurm-logs/103C_dribble_train_$(date +%Y%m%d_%H%M%S).log
