...
PORT_SEED=${PORT_SEED:-76}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))

export RUN_NAME=076_wide_student_distill_scratch_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r076_${PORT_SEED}
...
export TEAM_SIAMESE_ENCODER=1 TEAM_SIAMESE_ENCODER_HIDDENS=384,384 TEAM_SIAMESE_MERGE_HIDDENS=384,256
export TEAM_CROSS_ATTENTION=1 TEAM_CROSS_ATTENTION_TOKENS=4 TEAM_CROSS_ATTENTION_DIM=96
