...
mkdir -p docs/experiments/artifacts/official-evals/parallel-logs/063_T40_rerun1000v4
...
/home/hice1/wsun377/.venvs/soccertwos_h100/bin/python scripts/eval/evaluate_official_suite_parallel.py \
  ...
  --opponents baseline -n 1000 -j 1 --base-port 63505 \
  --save-logs-dir docs/experiments/artifacts/official-evals/parallel-logs/063_T40_rerun1000v4 \
  --checkpoint "$CKPT" \
  2>&1 | tee docs/experiments/artifacts/official-evals/063_T40_rerun1000v4.log
exit ${PIPESTATUS[0]}
