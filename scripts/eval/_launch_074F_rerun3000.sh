...
mkdir -p docs/experiments/artifacts/official-evals/parallel-logs/074F_rerun3000
...
/home/hice1/wsun377/.venvs/soccertwos_h100/bin/python scripts/eval/evaluate_official_suite_parallel.py \
  ...
  --opponents baseline -n 3000 -j 1 --base-port 53105 \
  --save-logs-dir docs/experiments/artifacts/official-evals/parallel-logs/074F_rerun3000 \
  --checkpoint "$DUMMY_CKPT" \
  2>&1 | tee docs/experiments/artifacts/official-evals/074F_rerun3000.log
exit ${PIPESTATUS[0]}
