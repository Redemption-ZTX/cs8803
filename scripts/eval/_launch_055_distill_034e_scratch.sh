...
PORT_SEED=${PORT_SEED:-37}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))

export RUN_NAME=055_distill_034e_ensemble_to_031B_scratch_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r055_${PORT_SEED}
