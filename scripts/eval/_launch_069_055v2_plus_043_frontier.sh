#!/bin/bash
# Tier 2: 055v2 recursive distill — add 055@1150 (current SOTA) + 056D@1140 (LR winner) to teacher pool.
# 5-teacher ensemble: 055@1150 + 031B@1220 + 045A@180 + 051A@130 + 056D@1140.
# Hypothesis: updated teacher pool + 056D's winning LR=3e-4 → break 055's 0.907 ceiling.
# Self-distillation (Furlanello 2018) + teacher-pool refresh.
set -euo pipefail
...
# PORT_SEED=51 — free (054=31, 055=37, 055lr3e4=41, 054M=43, 056extend=49)
PORT_SEED=${PORT_SEED:-161}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))

export RUN_NAME=069_055v2_plus_043_frontier_scratch_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r069_${PORT_SEED}
...
# *** 5-teacher ensemble: 055@1150 + 034e 3 models + 056D@1140 ***
export TEAM_DISTILL_ENSEMBLE_KL=1
export TEAM_DISTILL_TEACHER_ENSEMBLE_CHECKPOINTS="/storage/ice1/5/1/wsun377/ray_results_scratch/055_distill_034e_ensemble_to_031B_scratch_20260420_092037/TeamVsBaselineShapingPPOTrainer_Soccer_c6b12_00000_0_2026-04-20_09-21-01/checkpoint_001150/checkpoint-1150,/home/hice1/wsun377/Desktop/cs8803drl/ray_results/031B_team_cross_attention_scratch_v2_resume1080/TeamVsBaselineShapingPPOTrainer_Soccer_cd2d4_00000_0_2026-04-19_05-47-38/checkpoint_001220/checkpoint-1220,/home/hice1/wsun377/Desktop/cs8803drl/ray_results/045A_team_combo_on_031A1040_formal_rerun1/TeamVsBaselineShapingPPOTrainer_Soccer_be409_00000_0_2026-04-19_05-47-13/checkpoint_000180/checkpoint-180,/home/hice1/wsun377/Desktop/cs8803drl/ray_results/051A_combo_on_031B_with_051reward_512x512_20260419_110852/TeamVsBaselineShapingPPOTrainer_Soccer_b9914_00000_0_2026-04-19_11-09-13/checkpoint_000130/checkpoint-130,/storage/ice1/5/1/wsun377/ray_results_scratch/056D_pbt_lr0.00030_scratch_20260420_092042/TeamVsBaselineShapingPPOTrainer_Soccer_c9a5b_00000_0_2026-04-20_09-21-06/checkpoint_001140/checkpoint-1140"
...
# Inherit 056D's winning LR
export LR=0.0003 CLIP_PARAM=0.15
export BASELINE_PROB=1.0

# v2 shaping (same as 031B/054/055/056)
...
# SNAPSHOT-069: add 043-style frontier pool opponent mix
export OPPONENT_POOL_BASELINE_PROB=0.50
export OPPONENT_POOL_FRONTIER_SPECS="031B|team_ray|0.4|/home/hice1/wsun377/Desktop/cs8803drl/ray_results/031B_team_cross_attention_scratch_v2_resume1080/TeamVsBaselineShapingPPOTrainer_Soccer_cd2d4_00000_0_2026-04-19_05-47-38/checkpoint_001220/checkpoint-1220;031A|team_ray|0.3|/home/hice1/wsun377/Desktop/cs8803drl/ray_results/031A_team_dual_encoder_scratch_v2_512x512_20260418_054948/TeamVsBaselineShapingPPOTrainer_Soccer_fc02e_00000_0_2026-04-18_05-50-08/checkpoint_001040/checkpoint-1040;028A|team_ray|0.3|/home/hice1/wsun377/Desktop/cs8803drl/ray_results/PPO_team_level_bc_bootstrap_028A_512x512_formal/TeamVsBaselineShapingPPOTrainer_Soccer_85a0f_00000_0_2026-04-17_19-16-54/checkpoint_001060/checkpoint-1060"

# Budget: same as 055 (1250 iter scratch, ~12h)
...
LOG=docs/experiments/artifacts/slurm-logs/069_train_$(date +%Y%m%d_%H%M%S).log
