#!/bin/bash
# 062a: Curriculum + no-shape + adaptive gate (boundaries 0/200/500/1000 = 058 original)
...
export RUN_NAME=062a_curriculum_noshape_adaptive_0_200_500_1000_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r062a_${PORT_SEED}
...
LOG=docs/experiments/artifacts/slurm-logs/062a_train_$(date +%Y%m%d_%H%M%S).log
