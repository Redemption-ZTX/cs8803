#!/bin/bash
# 055 baseline rerun 500ep on peak ckpt neighborhood (1130, 1150, 1200)
# Combines with earlier 1000ep for ~ 1500-2000ep sample (SE ~0.010-0.007)
set -o pipefail
...
mkdir -p docs/experiments/artifacts/official-evals/parallel-logs/055_baseline_rerun500
...
/home/hice1/wsun377/.venvs/soccertwos_h100/bin/python scripts/eval/evaluate_official_suite_parallel.py \
  ...
  -j 3 \
  --base-port 59005 \
  --save-logs-dir docs/experiments/artifacts/official-evals/parallel-logs/055_baseline_rerun500 \
  ...
  2>&1 | tee docs/experiments/artifacts/official-evals/055_baseline_rerun500.log
exit ${PIPESTATUS[0]}
