...
PORT_SEED=${PORT_SEED:-71}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))
export RUN_NAME=066A_pure_selfdistill_from_055_1150_scratch_$(date +%Y%m%d_%H%M%S)
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r066A_${PORT_SEED}
