...
export RESTORE_CHECKPOINT="/storage/ice1/5/1/wsun377/ray_results_scratch/063_temp_distill_T30_on_034e_ensemble_031B_20260420_194828/TeamVsBaselineShapingPPOTrainer_Soccer_79b88_00000_0_2026-04-20_19-48-48/checkpoint_000590/checkpoint-590"
...
PORT_SEED=${PORT_SEED:-85}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))

export RUN_NAME=${RUN_NAME:-063_T30_resume_590_to_1250_$(date +%Y%m%d_%H%M%S)}
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r063_T30_${PORT_SEED}
...
export TEAM_DISTILL_TEMPERATURE=3.0      # snapshot-063: softer teacher distribution
...
LOG=docs/experiments/artifacts/slurm-logs/063_T30_temp_distill_train_$(date +%Y%m%d_%H%M%S).log
