...
export RESTORE_CHECKPOINT="/storage/ice1/5/1/wsun377/ray_results_scratch/054M_mat_medium_scratch_v2_512x512_20260420_135128/TeamVsBaselineShapingPPOTrainer_Soccer_a0dde_00000_0_2026-04-20_13-51-59/checkpoint_001250/checkpoint-1250"
...
PORT_SEED=${PORT_SEED:-89}
PORT_OFFSET=$(( (PORT_SEED % 60) * 50 ))

export RUN_NAME=054M_extend_resume_1250_to_1750_$(date +%Y%m%d_%H%M%S)
...
export TIMESTEPS_TOTAL=80000000 MAX_ITERATIONS=1750 TIME_TOTAL_S=86400 CHECKPOINT_FREQ=10
