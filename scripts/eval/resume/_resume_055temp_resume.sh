...
export RESTORE_CHECKPOINT="/storage/ice1/5/1/wsun377/ray_results_scratch/055temp_distill_034e_ensemble_to_031B_scratch_20260420_155212/TeamVsBaselineShapingPPOTrainer_Soccer_78f4d_00000_0_2026-04-20_15-52-33/checkpoint_001030/checkpoint-1030"
...
export RUN_NAME=${RUN_NAME:-055temp_resume_1030_to_1250_$(date +%Y%m%d_%H%M%S)}
export RAY_ADDRESS_OVERRIDE=local
export RAY_SESSION_TMPDIR_OVERRIDE=/tmp/r063_${PORT_SEED}
...
export TEAM_DISTILL_TEMPERATURE=2.0      # snapshot-063: softer teacher distribution
...
LOG=docs/experiments/artifacts/slurm-logs/063_temp_distill_train_$(date +%Y%m%d_%H%M%S).log
