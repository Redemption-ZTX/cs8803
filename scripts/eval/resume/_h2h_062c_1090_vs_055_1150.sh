#!/bin/bash
# H2H: 062c_1090 vs 055_1150 (500ep, port 32005)
set -o pipefail
cd /home/hice1/wsun377/Desktop/cs8803drl
mkdir -p docs/experiments/artifacts/official-evals/headtohead
export TRAINED_RAY_CHECKPOINT="/storage/ice1/5/1/wsun377/ray_results_scratch/062c_curriculum_noshape_adaptive_0_300_700_1100_20260420_142916/TeamVsBaselineShapingPPOTrainer_Soccer_e37fc_00000_0_2026-04-20_14-29-38/checkpoint_001090/checkpoint-1090"
...
/home/hice1/wsun377/.venvs/soccertwos_h100/bin/python scripts/eval/evaluate_headtohead.py \
  ...
  -e 500 -p 32005 \
  2>&1 | tee docs/experiments/artifacts/official-evals/headtohead/062c_1090_vs_055_1150.log
exit ${PIPESTATUS[0]}
