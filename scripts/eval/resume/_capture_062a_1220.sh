#!/bin/bash
# Failure capture: 062a_1220 vs baseline 500ep (save losses for bucket analysis)
set -o pipefail
cd /home/hice1/wsun377/Desktop/cs8803drl
mkdir -p docs/experiments/artifacts/failure-cases/062a_1220_baseline_500
...
/home/hice1/wsun377/.venvs/soccertwos_h100/bin/python scripts/eval/capture_failure_cases.py \
  --checkpoint "/storage/ice1/5/1/wsun377/ray_results_scratch/062a_curriculum_noshape_adaptive_0_200_500_1000_20260420_142908/TeamVsBaselineShapingPPOTrainer_Soccer_dd9fa_00000_0_2026-04-20_14-29-28/checkpoint_001220/checkpoint-1220" \
  --team0-module cs8803drl.deployment.trained_team_ray_agent \
  --opponent baseline \
  -n 500 \
  --max-steps 1500 \
  --base-port 37005 \
  --save-dir /home/hice1/wsun377/Desktop/cs8803drl/docs/experiments/artifacts/failure-cases/062a_1220_baseline_500 \
  --save-mode losses \
  ...
  2>&1 | tee docs/experiments/artifacts/official-evals/failure-capture-logs/062a_1220.log
exit ${PIPESTATUS[0]}
