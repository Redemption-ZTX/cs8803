...
export RESTORE_CHECKPOINT="/storage/ice1/5/1/wsun377/ray_results_scratch/055v2_recursive_distill_5teacher_lr3e4_scratch_20260420_142725/TeamVsBaselineShapingPPOTrainer_Soccer_a1e7d_00000_0_2026-04-20_14-27-48/checkpoint_001210/checkpoint-1210"
...
export RUN_NAME=055v2_extend_resume_1210_to_2000_$(date +%Y%m%d_%H%M%S)
...
export TIMESTEPS_TOTAL=90000000 MAX_ITERATIONS=2000 TIME_TOTAL_S=86400 CHECKPOINT_FREQ=10
...
LOG=docs/experiments/artifacts/slurm-logs/055v2_train_$(date +%Y%m%d_%H%M%S).log
