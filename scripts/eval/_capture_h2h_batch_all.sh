...
for i in "${!PAIRS[@]}"; do
  ...
  SAVE_DIR=docs/experiments/artifacts/failure-cases/h2h_v3_all/${NAME}_n500
  LOG=docs/experiments/artifacts/official-evals/failure-capture-logs/all_${NAME}.log
  mkdir -p "$SAVE_DIR"
